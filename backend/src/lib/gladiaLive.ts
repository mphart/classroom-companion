...
/** Env key name used in this repo; sent to Gladia as `x-gladia-key` on POST /v2/live. */
 ...
 * With translation enabled and `preferTranslation`, use `translation` events so text is in the target language.
 */
